...
function drop_category() {
    ajaxPromise('index.php?module=search&op=categoria',
    'POST','JSON')
    .then(function(data) {
        for (row in data) {
...
function drop_brands(categoria) {
    ajaxPromise('index.php?module=search&op=brand',
    'POST', 'JSON',  {categoria: categoria})
    .then(function(data) {
        $("#drop_brands").empty();
...
function autocomplete(){
    $("#autocom").on("keyup", function () {
        ...
        ajaxPromise('index.php?module=search&op=autocomplete',
        'POST', 'JSON', {drop_category: drop_category, drop_brands: drop_brands, complet: complet})
        .then(function(data) {
            $('#search_auto').empty();
            for (row in data) {
